package com.codeclan.example.employee_data.controllers;
...
public class DepartmentController {
    ...
    public Optional<Department> getDepartment(@PathVariable Long id) { return departmentRepository.findById(id); }
}
